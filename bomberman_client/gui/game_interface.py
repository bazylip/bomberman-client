...
class GameInterface:
    def __init__(self):
        ...
        self.player_image1 = pygame.image.load(
            "gui/images/player1.png").convert_alpha()
        self.player_image1 = pygame.transform.scale(
            self.player_image1, (50, 50))
        self.player_image2 = pygame.image.load(
            "gui/images/player2.png").convert_alpha()
        self.player_image2 = pygame.transform.scale(
            self.player_image2, (50, 50))
        self.bomb_image = pygame.image.load(
            "gui/images/bomb.png").convert_alpha()
    ...
    def _render_players(self, board_state):
        ...
        players = [(board_state.get("player1"), 1),
                   (board_state.get("player2"), 2)]
    ...
    def render_end_screen(self, id_player_won):
        self.display.fill(GRASS_COLOR)
        game_end = self.font.render(
            f"Game ended, player {id_player_won} won", False, (0, 0, 0))
